...
function dmg {
    ...
    tell application "Finder"
        tell disk "'${PRODUCT}'"
            ...
            set the bounds of container window to {100, 100, 580, 460}
            set theViewOptions to the icon view options of container window
            set arrangement of theViewOptions to not arranged
            set icon size of theViewOptions to 96
            set background picture of theViewOptions to file ".images:OSXSetup.png"
            make new alias file at container window to POSIX file "/Applications" with properties {name:"Applications"}
            set position of item "'${PRODUCT}'" of container window to {96, 192}
            set position of item "Applications" of container window to {376, 192}
