...
[.float-group]
--
image::legacy-linux.jpg[link=legacy-linux.jpg, width=400, float="left", title="HakuNeko for Linux (Legacy)", window="_blank"]
//image::legacy-windows.jpg[link=legacy-windows.jpg, width=400, float="right", title="HakuNeko for Windows (Legacy)", window="_blank"]
--
...
[.float-group]
--
image::screenshot-pages.png[link=screenshot-pages.png, width=400, float="left", title="HakuNeko S for Linux (electron)", window="_blank"]
--