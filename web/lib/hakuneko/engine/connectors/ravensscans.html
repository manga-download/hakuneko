...
<script>
     ...
     * 
     */
    class RavensScans extends Connector  {
        ...
        constructor() {
            ...
            super.id         = 'ravensscans';
            super.label      = 'RavensScans';
        ...
        _getJsonResponse( payload, type ) {
            ...
            let promise = fetch( this.url, this.requestOptions )
        ...
        _getPageList( manga, chapter, callback ) {
            ...
            .then( data => {
                ...
                let pageList = chapter.pages.map( page => {
                    let uri = new URL( ['/works', chapter.work.uniqid, chapter.uniqid, page.filename].join( '/' ), this.url );
                    return uri.href;
                    //let hash = 1; // 0 ~ 2
                    // CDN: Google
