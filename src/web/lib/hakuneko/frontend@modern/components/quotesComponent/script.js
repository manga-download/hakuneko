...
const quotes = [
    ...
    {
        lines: ["God ain't here. He's on vacation in Vegas."],
    ...
    {
        lines: ["Pornography can save the world!"],
        author: "Okajima Taiga, Ansatsu Kyoushitsu",
    },
    {
        lines: ["What kind of motivation you need more than pride?"],
    ...
    {
        lines: ["Caring for things bring a lot of trouble."],
    ...
    {
        lines: ["Here, have some water"],
        author: "Iori Kitahara, Grand Blue",
    },
    {
        lines: ["Io chiamo pinguini!"],
        author: "Italian Spider-man, Italian Spider-man",
    },
    {
        lines: ["It's fine now. Why? Because I am here!"],
    ...
    {
        lines: ["Wind always take something precious from me"],
        author: "Motoharu, Danshi Koukousei No Nichijou",
    },
    {
        lines: ["People die if they are killed."],
        author: "Shirou Emiya, FATE/Stay Night",
    },
    {
        lines: ["Saitei da... Orette."],
        author: "Shinji Ikari, Evangelion",
    },
    {
        lines: ["I know about the internet"],
    ...
    {
        lines: ["Zurumpu Ja Nai!! KATSURA DA!!!!!"],
    ...
    {
        lines: ["Eat when you can. I don't see anything wrong with that."],
    ...
    {
        lines: ["If the king doesn't move, then his subjects won't follow."],
        author: "Lelouch Vi Britannia, Code Geass",
    },
    {
        lines: ["If strength is justice, then is powerlessness a crime?"],
        author: "Lelouch Vi Britannia, Code Geass",
    },
    {
        lines: [
    ...
    {
        lines: ["You don't need a reason to fall in love, right?"],
        author: "Miu, Chrono Clock",
    },
    {
        lines: ["Just according to keikaku."],
    ...
    {
        lines: ["He only believes in what he believes in!"],
    ...
    {
        lines: ["When the sun shines, isn’t it warmer?"],
        author: "Mr. Kura, Maniattemasu!",
    },
    {
        lines: ["It is an honor to be despised by fools."],
        author: "Naru, Ghost Hunt",
    },
    {
        lines: ["Corpses should stay corpses. It is best if they do not move."],
        author: "Limit, Claymore",
    },
    {
        lines: ["Memories just get in the way of living."],
    ...
    {
        lines: ["ZA WARUDO! Toki yo tomare!"],
        author: "DIO, Jojo's Bizarre Adventure",
    },
    {
        lines: ["Smart people are smart before they even start studying."],
    ...
    {
        lines: ["We have to live a life of no regrets."],
        author: "Portgas D. Ace, One Piece",
    },
    {
        lines: ["You're gonna carry that weight."],
    ...
    {
        lines: ["The eyes of the queen sting without hesitation."],
        author: "Soifon, Bleach",
    },
    {
        lines: ["The intent to kill that is as beautiful as love."],
        author: "Ichimaru Gin, Bleach",
    },
    {
        lines: ["The white flower that quietly smiles. The ultimate healing."],
        author: "Unohana Retsu, Bleach",
    },
    {
        lines: ["Above Heaven, above the stars, and from even higher still."],
        author: "Aizen Sosuke, Bleach",
    },
    {
        lines: ["We must not be led astray by our hearts."],
        author: "Kuchiki Byakuya, Bleach",
    },
    {
        lines: ["Idly drinking…", "Idly daydreaming…"],
        author: "Shunsui Kyoraku, Bleach",
    },
    {
        lines: ["I don't fear death, death is to enjoyed, a scene of carnage!"],
    ...
    {
        lines: ["People die when they are forgtten."],
